...
<body>
    <div class="container">
        <div class="content">
            ...
            <p>My name is <span class="highlighted-name">Sujith</span>, I am an <span class="trainer">AWS and DevOps Trainer</span>.</p>
            ...
            <p><strong>LINUX AND SHELL SCRIPTING CONCEPTS</strong></p>
